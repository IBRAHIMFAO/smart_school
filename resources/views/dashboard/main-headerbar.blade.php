    ...
    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3"
        ...
        <ul class="navbar-nav flex-nowrap ms-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                        aria-expanded="false" data-bs-toggle="dropdown" href="#"><span
                            class="d-none d-lg-inline me-2 text-gray-600 small">{{Auth::user()->fullname}}</span>
                            {{-- <img
                            src="./assets/img/profile/stun%20pub%20(1).png?h=6700447931bec8bd30c5b8e38fdcc4fc"
                            width="50" height="50"> --}}
                    {{-- <img src="{{ asset('storage/' . Auth::user()->img) }}" width="50" height="50" alt="Profile Image"> --}}
                    ...
                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                        <a
                            {{-- class="dropdown-item" href="{{ route('profile') }}"><i --}}
                            class="dropdown-item" href="{{route('profile', Auth::user()->role)}}"><i
