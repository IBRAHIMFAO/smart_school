    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="text-center small mt-4">
                <span class="me-2"><i class="fas fa-circle text-primary"></i> Presence</span>
                <span class="me-2"><i class="fas fa-circle text-success"></i> Retard</span>
                <span class="me-2"><i class="fas fa-circle text-info" style="color: rgb(221,19,31);"></i> Absence</span>
            </div>
            <div class="text-center mt-4">
                <div>Presence Rate: {{ $presenceRate }}%</div>
                <div>Absence Rate: {{ $absenceRate }}%</div>
            </div>
        </div>
    </div>
</div> --}}
